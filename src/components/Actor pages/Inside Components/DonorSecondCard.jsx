          ...
          {({ open }) => (
            <>
              ...
              <Disclosure.Panel className="px-4 pt-4 pb-2 mb-6 text-sm text-gray-500">
                <div className="">
                    <h1 className="mr-6 text-xs font-medium text-neutral-400 mt-2"> {item.projectDescription} </h1>
                    <span className="drop-shadow-xl mt-4 font-medium text-black"> Amount Required  : </span>
                    <span className="drop-shadow-xl text-xl mt-4 font-medium text-black"> {item.amountRequire} </span>
                </div>
              </Disclosure.Panel>
            </>
          )}
