...
const LeftPart = ( {userData, actor, my_account} ) => {
  ...
  return (
    <div className="w-1/3 card rounded-xl p-2 pb-4 m-2">
            ...
            <div className="p-2">
              ...
              <h1 className="drop-shadow-xl  font-medium text-black"> {userData.name} </h1>
              <h1 className="drop-shadow-xl text-xs font-medium text-neutral-400 mt-4"> Email Id </h1>
              <h1 className="drop-shadow-xl  font-medium text-black"> {userData.email} </h1>
